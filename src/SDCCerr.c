...
struct {
  ...
  char disabled;
    ...
    {E_DUPLICATE, ERROR_LEVEL_ERROR, "Duplicate symbol '%s', symbol IGNORED",
     0},
    ...
    {E_OUT_OF_MEM, ERROR_LEVEL_ERROR, "'malloc' failed file '%s' for size %ld",
     0},
    {E_FILE_OPEN_ERR, ERROR_LEVEL_ERROR, "'fopen' failed on file '%s'", 0},
    {E_INVALID_OCLASS, ERROR_LEVEL_ERROR, "Internal Error Oclass invalid '%s'",
     0},
    {E_CANNOT_ALLOC, ERROR_LEVEL_ERROR, "Cannot allocate variable '%s'.", 0},
    {E_OLD_STYLE, ERROR_LEVEL_ERROR, "Old style C declaration. IGNORED '%s'",
     0},
    {E_STACK_OUT, ERROR_LEVEL_ERROR, "Out of stack Space. '%s' not allocated",
     0},
    ...
    {E_TMPFILE_FAILED, ERROR_LEVEL_ERROR, "Creation of temp file failed", 0},
    {E_FUNCTION_EXPECTED, ERROR_LEVEL_ERROR, "called object is not a function",
     0},
    {E_USING_ERROR, ERROR_LEVEL_ERROR,
     "'using', 'interrupt' or 'reentrant' must follow a function "
     "definition.'%s'",
     0},
    ...
    {E_AUTO_ABSA, ERROR_LEVEL_ERROR,
     "absolute address not allowed for automatic var '%s' in reentrant "
     "function ",
     0},
    {W_INIT_WRONG, ERROR_LEVEL_WARNING,
     "Initializer different levels of indirections", 0},
    {E_FUNC_REDEF, ERROR_LEVEL_ERROR, "Function name '%s' redefined ", 0},
    {E_ID_UNDEF, ERROR_LEVEL_ERROR, "Undefined identifier '%s'", 0},
    ...
    {E_IDX_NOT_INT, ERROR_LEVEL_ERROR, "Array index not an integer", 0},
    ...
    {E_NOT_MEMBER, ERROR_LEVEL_ERROR, "'%s' not a structure/union member", 0},
    {E_PTR_REQD, ERROR_LEVEL_ERROR, "Pointer required", 0},
    {E_UNARY_OP, ERROR_LEVEL_ERROR, "'unary %c': illegal operand", 0},
    {E_CONV_ERR, ERROR_LEVEL_ERROR,
     "conversion error: integral promotion failed", 0},
    {E_BITFLD_TYPE, ERROR_LEVEL_ERROR, "invalid type for bit-field", 0},
    {E_BITFLD_SIZE, ERROR_LEVEL_ERROR,
     "bit-field size too wide for type (max %d bits)", 0},
    {W_TRUNCATION, ERROR_LEVEL_WARNING, "high order truncation might occur", 0},
    {E_CODE_WRITE, ERROR_LEVEL_ERROR,
     "Attempt to assign value to a constant variable (%s)", 0},
    {E_LVALUE_CONST, ERROR_LEVEL_ERROR, "Lvalue specifies constant object", 0},
    {E_ILLEGAL_ADDR, ERROR_LEVEL_ERROR, "'&' illegal operand, %s", 0},
    {E_CAST_ILLEGAL, ERROR_LEVEL_ERROR,
     "illegal cast (cast cannot be aggregate)", 0},
    {E_MULT_INTEGRAL, ERROR_LEVEL_ERROR, "'*' bad operand", 0},
    {E_ARG_ERROR, ERROR_LEVEL_ERROR, "Argument count error, argument ignored",
     0},
    {E_ARG_COUNT, ERROR_LEVEL_ERROR, "Function was expecting more arguments",
     0},
    {E_FUNC_EXPECTED, ERROR_LEVEL_ERROR,
     "Function name expected '%s'. ANSI style declaration REQUIRED", 0},
    {E_PLUS_INVALID, ERROR_LEVEL_ERROR, "invalid operand '%s'", 0},
    {E_PTR_PLUS_PTR, ERROR_LEVEL_ERROR, "pointer + pointer invalid", 0},
    {E_SHIFT_OP_INVALID, ERROR_LEVEL_ERROR,
     "invalid operand for shift operator", 0},
    {E_COMPARE_OP, ERROR_LEVEL_ERROR, "operands are not comparable", 0},
    {E_BITWISE_OP, ERROR_LEVEL_ERROR, "operand invalid for bitwise operation",
     0},
    {E_ANDOR_OP, ERROR_LEVEL_ERROR, "Invalid operand for '&&' or '||'", 0},
    {E_TYPE_MISMATCH, ERROR_LEVEL_ERROR,
     "indirections to different types %s %s ", 0},
    {E_ARRAY_ASSIGN, ERROR_LEVEL_ERROR, "cannot assign values to arrays", 0},
    ...
    {E_RET_VALUE, ERROR_LEVEL_ERROR, "Function return value mismatch", 0},
    {E_FUNC_AGGR, ERROR_LEVEL_ERROR,
     "Function cannot return aggregate. Func body ignored", 0},
    {E_FUNC_DEF, ERROR_LEVEL_ERROR, "ANSI Style declaration needed", 0},
    {E_DUPLICATE_LABEL, ERROR_LEVEL_ERROR, "Duplicate label '%s'", 0},
    {E_LABEL_UNDEF, ERROR_LEVEL_ERROR, "Label undefined '%s'", 0},
    {E_FUNC_VOID, ERROR_LEVEL_ERROR, "void function returning value", 0},
    {W_VOID_FUNC, ERROR_LEVEL_WARNING, "function '%s' must return value", 0},
    {W_RETURN_MISMATCH, ERROR_LEVEL_WARNING, "function return value mismatch",
     0},
    ...
    {E_SWITCH_AGGR, ERROR_LEVEL_ERROR, "nonintegral used in switch expression",
     0},
    {E_FUNC_BODY, ERROR_LEVEL_ERROR, "function '%s' already has body", 0},
    ...
    {E_INIT_COUNT, ERROR_LEVEL_ERROR, "too many initializers", 0},
    ...
    {E_NO_MAIN, ERROR_LEVEL_ERROR, "function 'main' undefined", 0},
    {E_UNUSED_75, ERROR_LEVEL_ERROR, "this errorcode is no longer used", 0},
    {E_PRE_PROC_FAILED, ERROR_LEVEL_ERROR, "Pre-Processor %s", 0},
    {E_DUP_FAILED, ERROR_LEVEL_ERROR, "_dup call failed", 0},
    {E_INCOMPAT_TYPES, ERROR_LEVEL_ERROR, "incompatible types", 0},
    ...
    {E_OP_UNKNOWN_SIZE, ERROR_LEVEL_ERROR, "unknown size for operand", 0},
    ...
    {E_SFR_ADDR_RANGE, ERROR_LEVEL_ERROR, "%s '%s' address out of range", 0},
    ...
    {E_NONRENT_ARGS, ERROR_LEVEL_ERROR,
     "Functions called via pointers must be 'reentrant' to take this many "
     "(bytes for) arguments",
     0},
    ...
    {W_PRE_PROC_WARNING, ERROR_LEVEL_WARNING, "Pre-Processor %s", 0},
    ...
    {E_PREV_DECL_CONFLICT, ERROR_LEVEL_ERROR,
     "conflict with previous declaration of '%s' for attribute '%s' at %s:%d",
     0},
    ...
    {E_TOO_MANY_PARMS, ERROR_LEVEL_ERROR, "too many parameters ", 0},
    {E_TOO_FEW_PARMS, ERROR_LEVEL_ERROR, "too few parameters", 0},
    ...
    {E_INVALID_FLOAT_CONST, ERROR_LEVEL_ERROR, "invalid float constant '%s'",
     0},
    {E_INVALID_OP, ERROR_LEVEL_ERROR, "invalid operand for '%s' operation", 0},
    {E_SWITCH_NON_INTEGER, ERROR_LEVEL_ERROR, "switch value not an integer", 0},
    {E_CASE_NON_INTEGER, ERROR_LEVEL_ERROR, "case label not an integer", 0},
    ...
    {W_IMPLICIT_FUNC, ERROR_LEVEL_WARNING, "function '%s' implicit declaration",
     0},
    {W_CONTINUE, ERROR_LEVEL_WARNING, "%s", 0},
    ...
    {E_DIVIDE_BY_ZERO, ERROR_LEVEL_WARNING, "dividing by 0", 0},
    {E_FUNC_BIT, ERROR_LEVEL_ERROR, "function cannot return 'bit'", 0},
    {E_CAST_ZERO, ERROR_LEVEL_ERROR, "casting from to type 'void' is illegal",
     0},
    {W_CONST_RANGE, ERROR_LEVEL_WARNING, "constant is out of range %s", 0},
    {W_CODE_UNREACH, ERROR_LEVEL_PEDANTIC, "unreachable code", 0},
    ...
    {W_POSSBUG, ERROR_LEVEL_WARNING,
     ...
     0},
    {E_INCOMPAT_PTYPES, ERROR_LEVEL_ERROR, "pointer types incompatible ", 0},
    {W_UNKNOWN_MODEL, ERROR_LEVEL_WARNING, "unknown memory model at %s : %d",
     0},
    ...
    {E_INVALID_HEX, ERROR_LEVEL_ERROR, "\\x used with no following hex digits.",
     0},
    ...
    {E_ARGUMENT_MISSING, ERROR_LEVEL_ERROR, "Option %s requires an argument.",
     0},
    {W_STRAY_BACKSLASH, ERROR_LEVEL_WARNING, "stray '\\' at column %d", 0},
    {W_NEWLINE_IN_STRING, ERROR_LEVEL_WARNING, "newline in string constant", 0},
    ...
    {E_DUPLICATE_MEMBER, ERROR_LEVEL_ERROR, "duplicate %s member '%s'", 0},
    {E_STACK_VIOLATION, ERROR_LEVEL_ERROR, "'%s' internal stack %s", 0},
    {W_INT_OVL, ERROR_LEVEL_PEDANTIC, "integer overflow in expression", 0},
    {W_USELESS_DECL, ERROR_LEVEL_WARNING,
     "useless declaration (possible use of keyword as variable name)", 0},
    {E_INT_BAD_INTNO, ERROR_LEVEL_ERROR, "interrupt number '%u' is not valid",
     0},
    ...
    {E_NOT_ALLOWED, ERROR_LEVEL_ERROR, "%s not allowed here", 0},
    {E_BAD_TAG, ERROR_LEVEL_ERROR, "'%s' is not a %s tag", 0},
    ...
    {E_PREVIOUS_DEF, ERROR_LEVEL_ERROR, "previously defined here", 0},
    {W_SIZEOF_VOID, ERROR_LEVEL_WARNING, "size of void is zero", 0},
    {W_POSSBUG2, ERROR_LEVEL_WARNING,
     "possible code generation error at %s line %d,\n"
     " please report problem and send source code at sdcc-user list on "
     "sourceforge.net"},
    {W_COMPLEMENT, ERROR_LEVEL_WARNING,
     "using ~ on bit/bool/unsigned char variables can give unexpected results "
     "due to promotion to int",
     0},
    ...
    {W_CMP_SU_CHAR, ERROR_LEVEL_PEDANTIC,
     "comparison of 'signed char' with 'unsigned char' requires promotion to "
     "int",
     0},
    ...
    {E_NEGATIVE_ARRAY_SIZE, ERROR_LEVEL_ERROR, "Size of array '%s' is negative",
     0},
    ...
    {E_INCOMPLETE_FIELD, ERROR_LEVEL_ERROR, "field '%s' has incomplete type",
     0},
    ...
    {W_NORETURNRETURN, ERROR_LEVEL_WARNING, "return in _Noreturn function", 0},
    {E_STRUCT_REDEF, ERROR_LEVEL_ERROR, "struct/union '%s' redefined", 0},
    ...
    {S_SYNTAX_ERROR, ERROR_LEVEL_SYNTAX_ERROR, "token -> '%s' ; column %d", 0},
    {E_MIXING_CONFIG, ERROR_LEVEL_ERROR,
     "mixing __CONFIG and CONFIG directives", 0},
    {W_STATIC_ASSERTION, ERROR_LEVEL_WARNING, "static assertion failed: %s", 0},
    {E_ALIGNAS, ERROR_LEVEL_ERROR, "invalid alignment specified: %d", 0},
    ...
    {E_TYPE_IS_FUNCTION, ERROR_LEVEL_ERROR, "'%s' has function type", 0},
    {W_INLINE_NAKED, ERROR_LEVEL_WARNING, "inline function '%s' is __naked", 0},
    ...
    {W_REPEAT_QUALIFIER, ERROR_LEVEL_WARNING, "duplicate specifier '%s'", 0},
    {W_NO_TYPE_SPECIFIER, ERROR_LEVEL_WARNING, "no type specifier for '%s'", 0},
    {E_NO_TYPE_SPECIFIER, ERROR_LEVEL_ERROR, "no type specifier for '%s'", 0},
    ...
    {W_LABEL_WITHOUT_STATEMENT, ERROR_LEVEL_WARNING, "label without statement",
     0},
    ...
    {W_UNKNOWN_REG, ERROR_LEVEL_WARNING, "unknown register specification %s",
     0},
    ...
    {E_INT_MULTIPLE, ERROR_LEVEL_ERROR, "multiple interrupt numbers for '%s'",
     0},
    {W_INCOMPAT_PTYPES, ERROR_LEVEL_WARNING, "pointer types incompatible ", 0},
    {E_STATIC_ASSERTION_C2X, ERROR_LEVEL_ERROR,
     "static assertion with one argument requires C2X or later", 0},
    {W_STATIC_ASSERTION_2, ERROR_LEVEL_WARNING, "static assertion failed", 0},
    ...
    {E_AUTO_FILE_SCOPE, ERROR_LEVEL_ERROR, "auto in declaration at file scope",
     0},
    {E_U8_CHAR_C2X, ERROR_LEVEL_ERROR,
     "u8 character constant requires ISO C2X or later", 0},
    {E_U8_CHAR_INVALID, ERROR_LEVEL_ERROR, "invalid u8 character constant", 0},
    {E_ATTRIBUTE_C2X, ERROR_LEVEL_ERROR, "attribute requires C2X or later", 0},
    ...
    {W_SHIFT_NEGATIVE, ERROR_LEVEL_WARNING, "%s shift by negative amount", 0},
 ...
 * -------------------------------------------------------------------------------
 */
void setErrorLogLevel(ERROR_LOG_LEVEL level) { _SDCCERRG.logLevel = level; }
...
int vwerror(int errNum, va_list marker) {
  ...
  if (errNum > NELEM(ErrTab)) {
    fprintf(_SDCCERRG.out, "Internal error: bad error number %d.", errNum);
    return 0;
  }
  if (NELEM(ErrTab) != NUMBER_OF_ERROR_MESSAGES ||
      ErrTab[errNum].errIndex != errNum) {
  ...
  if ((ErrTab[errNum].errType >= _SDCCERRG.logLevel) &&
    ...
    for (oldmsg = setFirstItem(_SDCCERRG.log); oldmsg;
         oldmsg = setNextItem(_SDCCERRG.log))
 ...
 * -------------------------------------------------------------------------------
 */
void MSVC_style(int style) { _SDCCERRG.style = style; }
...
void setWarningDisabled(int errNum) {
  if ((errNum >= 0) && (errNum < NELEM(ErrTab)) &&
      (ErrTab[errNum].errType <= ERROR_LEVEL_WARNING))
 ...
 * -------------------------------------------------------------------------------
 */
void setWError(int flag) { _SDCCERRG.werror = flag; }
