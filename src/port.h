...
#define TARGET_PDK_LIKE false
#define TARGET_PIC_LIKE false
#define TARGET_IS_PIC16 false
#define TARGET_IS_PIC14 false
#define TARGET_IS_STM8 false
#define TARGET_Z80_LIKE true
