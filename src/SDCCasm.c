/*-------------------------------------------------------------------------
  SDCCasm.c - header file for all types of stuff to support different
assemblers.
...
const ASM_MAPPINGS asm_asxxxx_mapping = {NULL, _asxxxx_mapping};
...
const ASM_MAPPINGS asm_a390_mapping = {NULL, _a390_mapping};

#if !OPT_DISABLE_XA51
const ASM_MAPPINGS asm_xa_asm_mapping = {NULL, _xa_asm_mapping};
#endif
