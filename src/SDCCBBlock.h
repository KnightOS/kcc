...
typedef struct eBBlock {
  ...
  struct eBBlock *isConditionalExitFrom; /* this block ends with a return or
                                            goto from a conditional block */
  ...
  struct region
      *partOfLoop; /* pointer to the loop region this block is part of */
