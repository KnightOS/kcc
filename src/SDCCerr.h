...
enum {
  ...
  W_FUNCPTR_IN_USING_ISR =
      139, /* Call via function pointer in ISR with using attribute. */
  E_NO_SUCH_BANK =
      140, /* 'using' attribute specifies non-existant register bank. */
  E_TWO_OR_MORE_DATA_TYPES =
      141, /* two or more data types in declaration for '%s' */
  ...
  E_TWO_OR_MORE_STORAGE_CLASSES =
      146, /* two or more storage classes in declaration for '%s' */
  ...
  W_EXCESS_SHORT_OPTIONS = 152,  /* Only one short option can be specified at a
                                    time.  Rest of %s ignored. */
  E_VOID_VALUE_USED = 153,       /* void value not ignored as it ought to be */
  W_INTEGRAL2PTR_NOCAST =
      154, /* converting integral to pointer without a cast */
  W_PTR2INTEGRAL_NOCAST =
      155, /* converting pointer to integral without a cast */
  W_SYMBOL_NAME_TOO_LONG =
      156,                 /* symbol name too long, truncated to %d chars */
  ...
  E_PARAM_NAME_OMITTED =
      159, /* { in function %s: name omitted for parameter %d */
  W_NO_FILE_ARG_IN_C1 =
      160, /* only standard input is compiled in c1 mode. file '%s' ignored */
  E_NEED_OPT_O_IN_C1 =
      161, /* must specify assembler file name with -o in c1 mode */
  W_ILLEGAL_OPT_COMBINATION =
      162, /* illegal combination of options (--c1mode, -E, -S -c) */
  ...
  W_CMP_SU_CHAR = 185, /* comparison of 'signed char' with 'unsigned char'
                          requires promotion to int */
  W_INVALID_FLEXARRAY =
      186, /* invalid use of structure with flexible array member */
  W_C89_NO_FLEXARRAY =
      187, /* ISO C90 does not support flexible array members */
  ...
  E_STORAGE_CLASS_FOR_PARAMETER =
      198,                  /* storage class specified for parameter '%s' */
  ...
  W_STRING_CANNOT_BE_TERMINATED =
      211,                  /* string cannot be terminated within array */
  ...
  W_INTERNAL_ERROR = 217, /* warning for non-fatal internal errors - things that
